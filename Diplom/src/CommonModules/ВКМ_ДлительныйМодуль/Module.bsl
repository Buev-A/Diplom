...
//Функция СоздатьСписокНаСервере (Параметры, АдресРезультата) Экспорт
//	
//	Запрос = Новый Запрос;
//	Запрос.Текст = 
//		"ВЫБРАТЬ
...
//	
//	Запрос.УстановитьПараметр("Дата1", 	Параметры.ДатаНач1);
//	Запрос.УстановитьПараметр("Дата2", 	Параметры.ДатаОкон1);
//	
...
//	КонецЦикла;      
//	
//	Возврат СписокРеализацийСтруктура; 
//	
//КонецФункции
